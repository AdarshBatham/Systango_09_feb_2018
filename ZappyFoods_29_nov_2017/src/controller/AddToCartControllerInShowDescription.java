...
/**
 * Servlet implementation class AddToCartControllerInShowDescription
 */
@WebServlet("/AddToCartControllerInShowDescription")
public class AddToCartControllerInShowDescription extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddToCartControllerInShowDescription() {
        super();
